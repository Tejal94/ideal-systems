  ...
  return (
    <div>
      ...
      <section className="flex mt-10 flex-col">
        <p className="font-bold text-3xl underline underline-offset-8 text-[#222222] px-10 md:px-20 mb-5">
          WE HAVE WORKED WITH...
        </p>
        <div className="bg-[#ECF8FF] py-10 px-14">
          <ClientGrid2 />
        </div>
        <section className="flex flex-col md:flex-row items-center gap-y-5 mb-5">
          <img src={MapImage} className="md:max-w-3xl md:ml-10" />
          <div className="flex flex-col md:ml-16 gap-y-3 flex-1 content-center items-center">
            <p className="font-medium text-3xl text-center">250+ Clients</p>
            <button className="bg-[#0231A8] w-48 p-2 rounded-full self-center text-white header-button hidden md:block px-6 py-2.5 font-semibold text-center">
            View All
            </button>
          </div>
        </section>
